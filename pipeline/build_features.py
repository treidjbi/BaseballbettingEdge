...
def build_pitcher_record(odds: dict, stats: dict, ump_k_adj: float,
    ...
    return {
        ...
        "propline_event_id":  odds.get("propline_event_id"),
        "therundown_event_id": odds.get("therundown_event_id"),
        "market_source_mode": odds.get("market_source_mode"),
        "line_source_provider": odds.get("line_source_provider"),
        "source_snapshot_ids": odds.get("source_snapshot_ids"),
        "source_current_market_line_ids": odds.get("source_current_market_line_ids"),
        "official_market_line_id": odds.get("official_market_line_id"),
        "provider_coverage": odds.get("provider_coverage"),
        "provider_arbitration_reasons": odds.get("provider_arbitration_reasons"),
