-- Independent SELECT-only confirmation for approved tranche-v2-016.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('therundown', date '2026-06-15', 15525::bigint, 337::bigint),
    ('propline', date '2026-06-14', 5700::bigint, 194::bigint),
    ('therundown', date '2026-06-14', 8831::bigint, 336::bigint),
    ('therundown', date '2026-06-13', 23731::bigint, 612::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_016_postcheck_v1',
