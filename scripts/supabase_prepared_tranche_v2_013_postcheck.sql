-- Independent SELECT-only confirmation for approved tranche-v2-013.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('propline', date '2026-06-22', 12750::bigint, 178::bigint),
    ('therundown', date '2026-06-22', 21802::bigint, 463::bigint),
    ('propline', date '2026-06-21', 9304::bigint, 202::bigint),
    ('therundown', date '2026-06-21', 16956::bigint, 464::bigint),
    ('propline', date '2026-06-20', 14632::bigint, 204::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_013_postcheck_v1',
