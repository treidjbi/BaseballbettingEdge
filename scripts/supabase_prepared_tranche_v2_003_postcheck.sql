-- Independent SELECT-only confirmation for approved tranche-v2-003.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('propline', date '2026-07-21', 53588::bigint, 618::bigint),
    ('therundown', date '2026-07-21', 25098::bigint, 610::bigint),
    ('propline', date '2026-07-20', 51514::bigint, 642::bigint),
    ('therundown', date '2026-07-20', 24502::bigint, 586::bigint),
    ('propline', date '2026-07-19', 31264::bigint, 628::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_003_postcheck_v1',
