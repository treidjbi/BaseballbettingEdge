-- Independent SELECT-only confirmation for approved tranche-v2-012.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('therundown', date '2026-06-25', 14435::bigint, 377::bigint),
    ('propline', date '2026-06-24', 13146::bigint, 228::bigint),
    ('therundown', date '2026-06-24', 21085::bigint, 520::bigint),
    ('propline', date '2026-06-23', 13222::bigint, 208::bigint),
    ('therundown', date '2026-06-23', 24351::bigint, 523::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_012_postcheck_v1',
