-- Independent SELECT-only confirmation for approved tranche-v2-008.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('therundown', date '2026-07-06', 17916::bigint, 460::bigint),
    ('propline', date '2026-07-05', 39240::bigint, 642::bigint),
    ('therundown', date '2026-07-05', 17005::bigint, 538::bigint),
    ('propline', date '2026-07-04', 47732::bigint, 632::bigint),
    ('therundown', date '2026-07-04', 26048::bigint, 702::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_008_postcheck_v1',
