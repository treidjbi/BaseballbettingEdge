-- Independent SELECT-only confirmation for approved tranche-v2-015.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('propline', date '2026-06-17', 10560::bigint, 150::bigint),
    ('therundown', date '2026-06-17', 17304::bigint, 437::bigint),
    ('propline', date '2026-06-16', 17124::bigint, 196::bigint),
    ('therundown', date '2026-06-16', 24530::bigint, 516::bigint),
    ('propline', date '2026-06-15', 9598::bigint, 124::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_015_postcheck_v1',
