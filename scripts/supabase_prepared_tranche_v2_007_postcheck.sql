-- Independent SELECT-only confirmation for approved tranche-v2-007.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('propline', date '2026-07-08', 47113::bigint, 636::bigint),
    ('therundown', date '2026-07-08', 21536::bigint, 624::bigint),
    ('propline', date '2026-07-07', 43514::bigint, 608::bigint),
    ('therundown', date '2026-07-07', 24009::bigint, 662::bigint),
    ('propline', date '2026-07-06', 26684::bigint, 354::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_007_postcheck_v1',
