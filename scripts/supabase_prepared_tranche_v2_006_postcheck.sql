-- Independent SELECT-only confirmation for approved tranche-v2-006.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('therundown', date '2026-07-11', 24713::bigint, 694::bigint),
    ('propline', date '2026-07-10', 52228::bigint, 608::bigint),
    ('therundown', date '2026-07-10', 24025::bigint, 571::bigint),
    ('propline', date '2026-07-09', 35480::bigint, 536::bigint),
    ('therundown', date '2026-07-09', 17494::bigint, 550::bigint)
), raw_state as (
