-- Independent SELECT-only confirmation for approved tranche-v2-009.
with targets(provider, slate_date, expected_rows, expected_groups) as (
  values
    ('propline', date '2026-07-03', 13394::bigint, 210::bigint),
    ('therundown', date '2026-07-03', 20746::bigint, 524::bigint),
    ('propline', date '2026-07-02', 8808::bigint, 120::bigint),
    ('therundown', date '2026-07-02', 14608::bigint, 362::bigint),
    ('propline', date '2026-06-30', 16736::bigint, 216::bigint)
), raw_state as (
...
select jsonb_build_object(
  'scope_id', 'prepared_tranche_v2_009_postcheck_v1',
