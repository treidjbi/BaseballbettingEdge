...
| Tracking / data collection / history | `docs/research/market-tracker-map.md`, `2026-08-18-bounded-retention-audit.md`, `2026-08-20-retention-compaction-and-historical-extras-design.md`, `2026-08-20-retention-compaction-and-historical-extras.md`, compact outcome outputs, live-market audits | Canonical research and market/live/provider trackers remain active. The retention-compaction and historical-extra implementation is local and reviewed on `codex/retention-compaction-historical-extras`; the 2026-08-20 design and implementation plan are the controlling surfaces. Deterministic `(observed_at, id)` compaction, duplicate-source fail-closed handling, normalized strict compact logical keys, CASE-guarded canonical source expansion, strict `coverage_exact`, and separately recomputed `retention_preservation_complete` are implemented locally. No fresh bounded audit, database mutation, retention execution, deletion, vacuum, reclamation, push, merge, deployment, or production behavior change occurred. | Local merge review first. Any fresh bounded audit requires separate approval after merge and must re-evaluate strict coverage and every preservation gate from fresh evidence. Retention activation, deletion, vacuum, storage reclamation, provider/model/notification/lock/UI changes, push, and deployment remain closed. |
