...
| Model | `2026-05-12-pitcher-k-outcome-research-dataset.md`, `2026-05-29-gate-ef-under-fire-conversion-shadow-plan.md`, `2026-06-03-market-favorite-confidence-referee-shadow-plan.md`, `2026-06-03-gate-f-projection-challenger-shadow-plan.md` | Gate C durable artifact is now the preferred full-corpus research input. The market-favorite confidence-referee lab is implemented and close but not promotion-ready: validation rows are `220 < 250`, while the candidate is `107` rows, `67-40`, `+10.26`, `+9.6%`. The Gate F projection package is implemented and currently blocks all challengers: shrink variants are directionally useful but below MAE-lift threshold, and handedness remains hindsight-only. Gate E/F under-skepticism remains promising but not promotion-ready because the current selected candidate retained zero FIRE 2u wins. | Keep all model-facing work shadow-only. Regenerate market-favorite and Gate F reports after grading; if market-favorite clears the validation row threshold and survives slices, draft a separate production plan. Do not promote lambda, thresholds, staking, verdicts, provider order, notifications, dashboard behavior, or Path B handedness from these reports. |
