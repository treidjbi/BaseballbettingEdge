...
4. Read the newest active dated plans that match the task:
   - `docs/superpowers/plans/2026-09-04-forward-evidence-validator.md`
     for completed offline acceptance and the existing negative-score proof
     limitation; no capture, runner integration or formal credit
