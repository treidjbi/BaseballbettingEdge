...
- Also on 2026-06-07, Tyler approved a feature-flagged personal-use
  ...
  order, notifications, locks, retention, or dashboard source-of-truth. The
  code is pushed, but Render deploy/env activation is pending because the local
  Render CLI token is expired.
