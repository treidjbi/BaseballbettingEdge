...
- As of 2026-06-12 evening Phoenix time, the TheRundown mainline shadow canary
  ...
  high-frequency mainline evidence, allow PropLine book-level webhook rows to
...
- Live-layer market-state guardrails:
  ...
  - `LIVE_SEND_PROPLINE_WEBHOOK_MOVEMENT_NOTIFICATIONS=true` allows recent
    book-level PropLine webhook movement rows to create the same line/price
...
- As of 2026-06-14, Tyler approved promoting clean book-level webhook rows to
