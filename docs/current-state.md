...
The live market decision UI plan now has a hidden Phase 1 MVP:
`docs/superpowers/plans/2026-05-20-live-market-decision-ui.md`. It remains
display-only and shadow-only; Phase 2 live endpoint work, default-on dashboard
promotion, and any provider/model/betting-rule behavior still require separate
Tyler approval.
