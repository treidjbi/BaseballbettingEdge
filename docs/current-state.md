...
| Model | No new promotion justified. Live Alt V2 selected-frozen history through September 3 reconciles 113/113 rows and exact consumed locks: 49-63, one void, -24.889187u at frozen odds. Consensus is -11.089692u; Re-entry -13.799495u. Historical comparators and quoted-price PnL are not prospective fully costed profits. | The 75-freeze formal paired review is due now. Complete the full mainline comparison and missing quality/Path B/workload/model-market/CLV slices. Other candidates keep their existing attribution/diversity gates; no-drag stays retired and market-shrink diagnostic-only. |
...
| Tracking / data collection / history | Prepared cleanup is complete at 82/82 partitions. Current live physical database size is 6,143,741,075 bytes (~71.52% of 8 GiB), despite reusable space. The local Gate C manifest ends June 16; later hosted research must not be inferred from local generation dates. | Prioritize a separate consumed-lock research-linkage decision and bounded webhook backlog diagnosis; retain periodic size/coverage checks. Revisit structural zero eligibility or ongoing growth. New cleanup, physical rewrite and automatic retention remain separate gates. |
