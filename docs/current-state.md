...
4. Read the newest active dated plans that match the task:
   ...
   - `docs/superpowers/specs/2026-07-22-alt-picks-dependency-aware-v2-design.md`
     for Tyler's approved direction to replace the v1 global pending veto with
     dependency-aware lane resolution and exact candidate-grain Preclose
     evidence; the written specification awaits Tyler's final review before
     implementation planning, and no production behavior has changed
