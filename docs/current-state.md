...
4. Read the newest active dated plans that match the task:
   - `docs/superpowers/plans/2026-09-04-bounded-forward-capture-proposal.md`
     for the completed offline prototype and stop decision: historical September 3
     has 12 inventoried opportunities and zero complete inputs; hosted capture closed
