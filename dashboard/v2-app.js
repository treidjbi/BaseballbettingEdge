...
function PickCard({ p, onOpen }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    p.quality_gate_level && p.quality_gate_level !== "clean" && /* @__PURE__ */ React.createElement("div", { className: "v2-tracked-row" }, /* @__PURE__ */ React.createElement("span", { className: `v2-tracked-pill ${p.quality_gate_level === "blocked" ? "locked" : ""}` }, qualityLabel(p.quality_gate_level)), side.raw_verdict && side.raw_verdict !== side.verdict && /* @__PURE__ */ React.createElement("span", { className: "v2-tracked-pill" }, "Raw ", side.raw_verdict)),
