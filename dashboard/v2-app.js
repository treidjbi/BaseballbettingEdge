...
function PickDetail({
  ...
  const SideCard = ({
    ...
    }, pos ? "+" : "", (s.adj_ev * 100).toFixed(1), "%"), React.createElement("div", {
      className: "wp"
  ...
  return ReactDOM.createPortal(React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    className: "live-meta"
  }, "Projected final: ", React.createElement("b", null, live.proj_final_k.toFixed(1), " K"), React.createElement("span", {
    ...
    className: "pass-copy"
  }, "Model projection (", p.lambda.toFixed(2), " K) is too close to the line (", p.k_line, ") on both sides. Skipping this one.")), React.createElement("div", {
    ...
    className: "val"
  }, p.k_line)), React.createElement("div", {
    className: "v2-stat-row"
  }, React.createElement("span", {
    className: "lbl"
  }, "Model \u03BB"), React.createElement("span", {
    className: "val"
  }, p.lambda.toFixed(2))), React.createElement("div", {
    className: "v2-stat-row"
  }, React.createElement("span", {
    className: "lbl"
  }, "Edge"), React.createElement("span", {
    className: `val ${p.lambda > p.k_line ? "pos" : "neg"}`
  }, p.lambda > p.k_line ? "+" : "", (p.lambda - p.k_line).toFixed(2), " K")), React.createElement("div", {
    className: "v2-stat-row"
  }, React.createElement("span", {
    className: "lbl"
  }, "Expected IP"), React.createElement("span", {
    className: "val"
  }, p.avg_ip.toFixed(1)))), React.createElement("div", {
    className: "v2-sheet-section"
  }, React.createElement("div", {
    className: "h"
    ...
    className: "lbl"
  }, "Park factor"), p.park_factor != null ? React.createElement("span", {
    className: `val ${helpers.parkFactorTone ? helpers.parkFactorTone(p.park_factor, best.direction) : ""}`
  }, p.park_factor.toFixed(2)) : React.createElement("span", {
    className: "val",
    style: {
      color: "var(--ink-dim)"
    }
  }, "Unknown")), React.createElement("div", {
    className: "v2-stat-row"
  }, React.createElement("span", {
    className: "lbl"
  }, Icon.users, " Opp. K-rate (bats)"), React.createElement("span", {
    className: `val ${oppSupports ? "pos" : "neg"}`
  }, (p.opp_k_rate * 100).toFixed(1), "%", React.createElement("span", {
    className: "delta"
  ...
  }, p.recent_k9.toFixed(1), React.createElement("span", {
    className: "delta"
    ...
    className: "val"
  }, p.season_k9.toFixed(1))), React.createElement("div", {
    className: "v2-stat-row"
  }, React.createElement("span", {
    className: "lbl"
  }, "Career K/9"), React.createElement("span", {
    className: "val"
  }, p.career_k9.toFixed(1)))), React.createElement("div", {
    className: "v2-sheet-section"
  }, React.createElement("div", {
    className: "h"
