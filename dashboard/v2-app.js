(() => {
  ...
  var Icon = {
    ...
    history: /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 20 20", width: "20", height: "20", fill: "none", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M4 4v4h4" }), /* @__PURE__ */ React.createElement("path", { d: "M4.4 8A6.2 6.2 0 1 0 6 4.1" }), /* @__PURE__ */ React.createElement("path", { d: "M10 6.5V10l2.4 1.6" })),
  ...
  function sameMarketLine(row, side, p = null) {
    ...
    return Math.abs(row.best_line - modelLine) < 1e-3;
  }
  ...
  function isLiveMarketBetPrefill(row, side = null, p = null) {
    ...
    return ["playable", "playable_price", "shop_price", "market_agrees"].includes(label) || ["playable_now", "off_market"].includes(row.actionable_state);
  }
  ...
  function historySideFromPitcher(p) {
    ...
    const side = (over.adj_ev ?? -99) >= (under.adj_ev ?? -99) ? { ...over, direction: "OVER", odds: p.best_over_odds, opening: p.opening_over_odds } : { ...under, direction: "UNDER", odds: p.best_under_odds, opening: p.opening_under_odds };
    return {
      ...side,
  ...
  function MarketCardStrip({ p, side }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: `v2-market-strip ${tone}` }, /* @__PURE__ */ React.createElement("span", { className: "v2-market-strip-k" }, "Market"), /* @__PURE__ */ React.createElement("span", { className: "v2-market-strip-main" }, marketActionText(row, side, p)), /* @__PURE__ */ React.createElement("span", { className: "v2-market-strip-sub" }, bestMarketText(row)));
  }
  ...
  function PickCard({ p, onOpen }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(MarketCardStrip, { p, side }),
  ...
  function PickDetail({ p, onClose }) {
    ...
    return ReactDOM.createPortal(
      /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-backdrop", onClick: onClose }), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet", role: "dialog", "aria-modal": "true" }, /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-grip" }), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "meta" }, ab(p.team), " vs ", ab(p.opp_team), " \xB7 ", isLive ? "LIVE" : isFinal ? "FINAL" : fmtTime(p.game_time)), /* @__PURE__ */ React.createElement("div", { className: "pitcher" }, p.pitcher, /* @__PURE__ */ React.createElement("span", { className: "throws" }, p.pitcher_throws, "HP"))), /* @__PURE__ */ React.createElement("button", { className: "v2-sheet-close", onClick: onClose, "aria-label": "Close" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 3l10 10M13 3L3 13" })))), isLive && live && /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-state v2-sheet-live" }, /* @__PURE__ */ React.createElement("div", { className: "state-head" }, /* @__PURE__ */ React.createElement("span", { className: "pulse" }), /* @__PURE__ */ React.createElement("span", { className: "state-lbl" }, "LIVE \xB7 ", live.innings, " IP \xB7 ", live.pitches, " pitches")), /* @__PURE__ */ React.createElement("div", { className: "live-k" }, /* @__PURE__ */ React.createElement("span", { className: "live-k-num" }, live.current_k), /* @__PURE__ */ React.createElement("span", { className: "live-k-sep" }, "/"), /* @__PURE__ */ React.createElement("span", { className: "live-k-line" }, p.k_line), /* @__PURE__ */ React.createElement("span", { className: "live-k-lbl" }, "K")), /* @__PURE__ */ React.createElement("div", { className: "live-meta" }, "Projected final: ", /* @__PURE__ */ React.createElement("b", null, fmtFixedOrDash(live.proj_final_k, 1), " K"), /* @__PURE__ */ React.createElement("span", { className: `live-verdict ${isFiniteNumber(live.proj_final_k) && kLine != null && live.proj_final_k > kLine ? "over" : "under"}` }, live.proj_final_k > p.k_line ? "\u2192 OVER pace" : "\u2192 UNDER pace"))), isLive && !live && /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-state v2-sheet-live" }, /* @__PURE__ */ React.createElement("div", { className: "state-head" }, /* @__PURE__ */ React.createElement("span", { className: "pulse" }), /* @__PURE__ */ React.createElement("span", { className: "state-lbl" }, "LIVE \xB7 game in progress")), /* @__PURE__ */ React.createElement("div", { className: "live-meta" }, "Live K tracking not wired yet \u2014 pipeline does not hydrate in-game stats.")), isFinal && !result && /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-state v2-sheet-final outcome-pass" }, /* @__PURE__ */ React.createElement("div", { className: "state-head" }, /* @__PURE__ */ React.createElement("span", { className: "state-lbl" }, "FINAL")), /* @__PURE__ */ React.createElement("div", { className: "final-meta" }, "Grading not available in today's snapshot \u2014 check Results tab.")), isFinal && result && /* @__PURE__ */ React.createElement("div", { className: `v2-sheet-state v2-sheet-final outcome-${result.outcome}` }, /* @__PURE__ */ React.createElement("div", { className: "state-head" }, /* @__PURE__ */ React.createElement("span", { className: "state-lbl" }, "FINAL \xB7 ", result.final_k, " K")), result.outcome === "pass" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "final-outcome" }, "NO BET"), /* @__PURE__ */ React.createElement("div", { className: "final-meta" }, "Model found no edge on either side. Line closed at ", p.k_line, ", final ", result.final_k, " K", result.final_k > p.k_line ? " \xB7 OVER hit" : result.final_k < p.k_line ? " \xB7 UNDER hit" : " \xB7 push", ".")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "final-outcome" }, result.outcome === "win" ? "WIN" : result.outcome === "loss" ? "LOSS" : "PUSH", /* @__PURE__ */ React.createElement("span", { className: `final-units ${result.units_won >= 0 ? "pos" : "neg"}` }, result.units_won >= 0 ? "+" : "", result.units_won.toFixed(2), "u")), /* @__PURE__ */ React.createElement("div", { className: "final-meta" }, result.side_taken?.toUpperCase(), " ", result.line_at_bet, " @ ", fmtOdds(result.odds_at_bet), " \xB7 ", result.units_risked, "u risked"))), isPass && !isLive && !isFinal && /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-state v2-sheet-pass" }, /* @__PURE__ */ React.createElement("div", { className: "state-head" }, /* @__PURE__ */ React.createElement("span", { className: "state-lbl" }, "NO EDGE")), /* @__PURE__ */ React.createElement("div", { className: "pass-copy" }, "Model projection (", fmtFixedOrDash(lambda, 2), " K) is too close to the line (", kLine ?? "--", ") on both sides. Skipping this one.")), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-section" }, /* @__PURE__ */ React.createElement("div", { className: "h" }, "Sides \xB7 EV ROI comparison"), /* @__PURE__ */ React.createElement("div", { className: "v2-sides" }, /* @__PURE__ */ React.createElement(SideCard, { s: displayOver }), /* @__PURE__ */ React.createElement(SideCard, { s: displayUnder }))), /* @__PURE__ */ React.createElement(MarketDecisionPanel, { p, side: best }), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-section" }, /* @__PURE__ */ React.createElement("div", { className: "h" }, "Projection"), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Line (K)"), /* @__PURE__ */ React.createElement("span", { className: "val" }, kLine ?? "--")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Model \u03BB"), /* @__PURE__ */ React.createElement("span", { className: "val" }, fmtFixedOrDash(lambda, 2))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Edge"), /* @__PURE__ */ React.createElement("span", { className: `val ${lambda == null || kLine == null ? "" : lambda > kLine ? "pos" : "neg"}` }, lambda == null || kLine == null ? "--" : `${lambda > kLine ? "+" : ""}${(lambda - kLine).toFixed(2)} K`)), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Expected IP"), /* @__PURE__ */ React.createElement("span", { className: "val" }, fmtFixedOrDash(avgIp, 1)))), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-section" }, /* @__PURE__ */ React.createElement("div", { className: "h" }, "Why this bet"), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, Icon.users, " Lineup"), p.lineup_used ? /* @__PURE__ */ React.createElement("span", { className: "val pos" }, "Confirmed") : /* @__PURE__ */ React.createElement("span", { className: "val", style: { color: "var(--ink-dim)" } }, "Projected")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, Icon.ump, " Umpire"), umpireHasRating ? /* @__PURE__ */ React.createElement("span", { className: `val ${umpSupports ? "pos" : "neg"}` }, "Confirmed", /* @__PURE__ */ React.createElement("span", { className: "delta" }, ump > 0 ? "+" : "", ump.toFixed(2))) : umpireName ? /* @__PURE__ */ React.createElement("span", { className: "val", style: { color: "var(--ink-dim)" } }, umpireName, /* @__PURE__ */ React.createElement("span", { className: "delta" }, "neutral")) : /* @__PURE__ */ React.createElement("span", { className: "val", style: { color: "var(--ink-dim)" } }, "TBA")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Park factor"), parkFactor != null ? /* @__PURE__ */ React.createElement("span", { className: `val ${helpers.parkFactorTone ? helpers.parkFactorTone(parkFactor, best.direction) : ""}` }, parkFactor.toFixed(2)) : /* @__PURE__ */ React.createElement("span", { className: "val", style: { color: "var(--ink-dim)" } }, "Unknown")), /* @__PURE__ */ React.createElement(
        ...
        )), needsBetLogSecret && String(betForm.secret || "").trim() && acceptedBetReview.state !== "loading" && acceptedBetReview.state !== "ready" && /* @__PURE__ */ React.createElement(
          "button",
          {
            type: "button",
  ...
  function HistoryTab() {
    ...
    const openSlate = (date) => {
      ...
      const u = new URL(location.href);
      if (date === today2) u.searchParams.delete("date");
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "v2-header" }, /* @__PURE__ */ React.createElement("div", { className: "v2-header-row" }, /* @__PURE__ */ React.createElement("div", { className: "v2-brand" }, /* @__PURE__ */ React.createElement("div", { className: "v2-kmark" }, "K"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "v2-wordmark" }, "History"), /* @__PURE__ */ React.createElement("div", { className: "v2-subtitle" }, "Completed slates - pitcher and team lookup"))), /* @__PURE__ */ React.createElement("div", { className: "v2-header-actions" }, /* @__PURE__ */ React.createElement("button", { className: "v2-icon-btn", title: "Theme", onClick: () => window.__v2Theme?.toggleTheme() }, window.__v2Theme?.theme === "dark" ? Icon.sun : Icon.moon)))), /* @__PURE__ */ React.createElement("div", { className: "v2-history-hero" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "n" }, filtered.length)), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { className: "lbl" }, "Rows in view"), /* @__PURE__ */ React.createElement("div", { className: "ttl" }, state.status === "loading" ? "Loading recent slates" : `${wins}W-${losses}L - ${fireCount} FIRE`), state.skipped > 0 && /* @__PURE__ */ React.createElement("div", { className: "v2-history-note" }, state.skipped, " archived date", state.skipped === 1 ? "" : "s", " skipped"))), /* @__PURE__ */ React.createElement("div", { className: "v2-history-tools" }, /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "v2-history-select-row" }, /* @__PURE__ */ React.createElement("select", { value: dateFilter, onChange: (e) => setDateFilter(e.target.value), "aria-label": "Filter by date" }, /* @__PURE__ */ React.createElement("option", { value: "ALL" }, "All dates"), completedDates.slice(0, 14).map((d) => /* @__PURE__ */ React.createElement("option", { key: d.date, value: d.date }, d.date))), /* @__PURE__ */ React.createElement("select", { value: teamFilter, onChange: (e) => setTeamFilter(e.target.value), "aria-label": "Filter by team" }, /* @__PURE__ */ React.createElement("option", { value: "ALL" }, "All teams"), teams.map((team) => /* @__PURE__ */ React.createElement("option", { key: team, value: team }, team))))), /* @__PURE__ */ React.createElement("div", { className: "v2-steam-filter v2-history-filter" }, [["ALL", "All"], ["FIRE", "Fire"], ["LEAN", "Lean"]].map(([k, l]) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: k,
      ...
      l
    ))), /* @__PURE__ */ React.createElement("div", { className: "v2-history-list" }, state.status === "loading" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "v2-skel-card" }, /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 18, width: "55%" } }), /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 12, width: "80%" } }), /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 34, width: "100%" } })), /* @__PURE__ */ React.createElement("div", { className: "v2-skel-card" }, /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 18, width: "45%" } }), /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 12, width: "70%" } }), /* @__PURE__ */ React.createElement("div", { className: "v2-skel", style: { height: 34, width: "100%" } }))), state.status === "error" && /* @__PURE__ */ React.createElement("div", { className: "v2-state" }, /* @__PURE__ */ React.createElement("div", { className: "ttl" }, "History unavailable"), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "Could not load the recent slate archive."), /* @__PURE__ */ React.createElement("div", { className: "err-detail" }, state.error)), state.status === "ready" && filtered.map((r, i) => {
      ...
      const steam = r.steam;
      return /* @__PURE__ */ React.createElement("article", { key: `${r.date}-${r.pitcher}-${r.direction}-${i}`, className: `v2-history-row ${verdictClass(r.verdict, r.direction)}` }, /* @__PURE__ */ React.createElement("button", { className: "v2-history-date", type: "button", onClick: () => openSlate(r.date), title: "Open slate" }, /* @__PURE__ */ React.createElement("span", null, (/* @__PURE__ */ new Date(`${r.date}T00:00:00Z`)).toLocaleDateString("en-US", { month: "short", day: "numeric", timeZone: "UTC" })), /* @__PURE__ */ React.createElement("span", null, "View")), /* @__PURE__ */ React.createElement("div", { className: `v2-steam-dir ${sideClass}` }, r.direction === "OVER" ? "OV" : "UN"), /* @__PURE__ */ React.createElement("div", { className: "v2-history-main" }, /* @__PURE__ */ React.createElement("div", { className: "v2-history-name" }, r.pitcher), /* @__PURE__ */ React.createElement("div", { className: "v2-history-meta" }, ab(r.team), " vs ", ab(r.opp_team), " - ", r.direction, " ", r.k_line, " K - ", fmtOdds(r.odds)), /* @__PURE__ */ React.createElement("div", { className: "v2-history-tags" }, /* @__PURE__ */ React.createElement("span", { className: `v2-history-verdict ${verdictClass(r.verdict, r.direction)}` }, r.verdict), /* @__PURE__ */ React.createElement("span", { className: `v2-history-result ${resultClass}` }, result === "pending" ? "Pending" : result.toUpperCase(), r.actual_ks != null ? ` - ${r.actual_ks} K` : ""), steam && /* @__PURE__ */ React.createElement("span", { className: `v2-steam ${steam.steamWith ? "with" : "against"}` }, steam.steamWith ? "odds with" : "odds against", " ", steam.cents, "c"))), /* @__PURE__ */ React.createElement("div", { className: "v2-history-ev" }, /* @__PURE__ */ React.createElement("span", { className: (r.adj_ev ?? 0) >= 0 ? "pos" : "neg" }, (r.adj_ev ?? 0) >= 0 ? "+" : "", ((r.adj_ev ?? 0) * 100).toFixed(1), "%"), /* @__PURE__ */ React.createElement("span", null, "EV ROI")));
    }), state.status === "ready" && filtered.length === 0 && /* @__PURE__ */ React.createElement("div", { className: "v2-state" }, /* @__PURE__ */ React.createElement("div", { className: "ttl" }, "No matching history"), /* @__PURE__ */ React.createElement("div", { className: "sub" }, "Try clearing a filter or searching another pitcher or team."))));
  }
  function App() {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, tab === "picks" && renderPicks(), tab === "perf" && /* @__PURE__ */ React.createElement(PerfTab, null), tab === "history" && /* @__PURE__ */ React.createElement(HistoryTab, null), /* @__PURE__ */ React.createElement("nav", { className: "v2-tabbar" }, [
