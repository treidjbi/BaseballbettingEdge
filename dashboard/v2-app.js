...
function PickCard({ p, onOpen }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "v2-line" }, /* @__PURE__ */ React.createElement("div", { className: "v2-line-cell" }, /* @__PURE__ */ React.createElement("div", { className: "v2-line-label" }, "Line \xB7 ", side.direction), /* @__PURE__ */ React.createElement("div", { className: "v2-line-value" }, p.k_line, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, opacity: 0.5 } }, " K")), /* @__PURE__ */ React.createElement("div", { className: "v2-line-sub mono" }, fmtOdds(side.odds), " \xB7 ", side.direction === "OVER" ? p.best_over_book || "book" : p.best_under_book || "book")), /* @__PURE__ */ React.createElement("div", { className: "v2-line-cell" }, /* @__PURE__ */ React.createElement("div", { className: "v2-line-label" }, "Projection"), /* @__PURE__ */ React.createElement("div", { className: "v2-line-value" }, p.lambda.toFixed(2)), /* @__PURE__ */ React.createElement(ProjBar, { line: p.k_line, lambda: p.lambda })), /* @__PURE__ */ React.createElement("div", { className: "v2-line-cell" }, /* @__PURE__ */ React.createElement("div", { className: "v2-line-label" }, "EV ROI \xB7 Edge"), /* @__PURE__ */ React.createElement("div", { className: `v2-line-value ${side.adj_ev > 0 ? "pos" : "neg"}` }, side.adj_ev > 0 ? "+" : "", (side.adj_ev * 100).toFixed(1), "%"), /* @__PURE__ */ React.createElement("div", { className: "v2-line-sub mono" }, "edge ", (side.edge ?? side.ev) > 0 ? "+" : "", (((side.edge ?? side.ev) || 0) * 100).toFixed(1), "% \xB7 p = ", (side.win_prob * 100).toFixed(1), "%"))),
...
function PickDetail({ p, onClose }) {
  ...
  return ReactDOM.createPortal(
    ...
    ), showFactorDetails && /* @__PURE__ */ React.createElement("div", { className: "v2-factor-panel", id: "v2-factor-details" }, factorGroups.map((group) => /* @__PURE__ */ React.createElement("div", { className: "v2-factor-group", key: group.key }, /* @__PURE__ */ React.createElement("div", { className: "v2-factor-group-h" }, group.label), /* @__PURE__ */ React.createElement("div", { className: "v2-factor-rows" }, group.rows.map((row) => /* @__PURE__ */ React.createElement("div", { className: "v2-factor-row", key: row.key }, /* @__PURE__ */ React.createElement("div", { className: "v2-factor-row-top" }, /* @__PURE__ */ React.createElement("span", { className: "v2-factor-label" }, row.label), /* @__PURE__ */ React.createElement("span", { className: `v2-factor-pill ${row.status}` }, row.status)), /* @__PURE__ */ React.createElement("div", { className: `v2-factor-value ${row.tone ? row.tone : ""}` }, row.value), row.note && /* @__PURE__ */ React.createElement("div", { className: "v2-factor-note" }, row.note))))))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, Icon.users, " Opp. K-rate (bats)"), /* @__PURE__ */ React.createElement("span", { className: `val ${oppSupports ? "pos" : "neg"}` }, (p.opp_k_rate * 100).toFixed(1), "%", /* @__PURE__ */ React.createElement("span", { className: "delta" }, oppDelta >= 0 ? "+" : "", oppDelta.toFixed(1), " vs lg"))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, Icon.ball, " Recent K/9 (L5)"), /* @__PURE__ */ React.createElement("span", { className: `val ${k9Supports ? "pos" : "neg"}` }, p.recent_k9.toFixed(1), /* @__PURE__ */ React.createElement("span", { className: "delta" }, k9Delta >= 0 ? "+" : "", k9Delta.toFixed(1), " vs lg"))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Season K/9"), /* @__PURE__ */ React.createElement("span", { className: "val" }, p.season_k9.toFixed(1))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Career K/9"), /* @__PURE__ */ React.createElement("span", { className: "val" }, p.career_k9.toFixed(1)))), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-section" }, /* @__PURE__ */ React.createElement("div", { className: "h" }, `FanDuel \xB7 ${best.direction} \xB7 open to now`, movementSummary?.lineMoved && /* @__PURE__ */ React.createElement("span", { className: "v2-line-move-badge" }, `line moved ${movementSummary.openingLine} -> ${movementSummary.currentLine}`)), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Opening line"), /* @__PURE__ */ React.createElement("span", { className: "val" }, p.opening_line, " \xB7 ", fmtOdds(p.opening_over_odds), "/", fmtOdds(p.opening_under_odds))), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Current line"), /* @__PURE__ */ React.createElement("span", { className: "val" }, p.k_line, " \xB7 ", fmtOdds(sideOver.odds), "/", fmtOdds(sideUnder.odds))), /* @__PURE__ */ React.createElement(MovementChart, { movement }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--ink-dim)", marginTop: 6, fontFamily: "JetBrains Mono, monospace" } }, steam.cents > 0 ? `${steam.cents}\xA2 ${steam.steamWith ? "with" : "against"} the pick` : "No steam signal at the picked side price")), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-section" }, /* @__PURE__ */ React.createElement("div", { className: "h" }, "Model confidence"), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Verdict"), /* @__PURE__ */ React.createElement("span", { className: "val" }, best.verdict)), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Movement confidence"), /* @__PURE__ */ React.createElement("span", { className: "val" }, (best.movement_conf * 100).toFixed(0), "%")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Edge"), /* @__PURE__ */ React.createElement("span", { className: `val ${((best.edge ?? best.ev) || 0) > 0 ? "pos" : "neg"}` }, ((best.edge ?? best.ev) || 0) > 0 ? "+" : "", (((best.edge ?? best.ev) || 0) * 100).toFixed(1), "%")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Raw EV ROI"), /* @__PURE__ */ React.createElement("span", { className: "val" }, best.ev > 0 ? "+" : "", (best.ev * 100).toFixed(1), "%")), /* @__PURE__ */ React.createElement("div", { className: "v2-stat-row" }, /* @__PURE__ */ React.createElement("span", { className: "lbl" }, "Adjusted EV ROI"), /* @__PURE__ */ React.createElement("span", { className: `val ${best.adj_ev > 0 ? "pos" : "neg"}` }, best.adj_ev > 0 ? "+" : "", (best.adj_ev * 100).toFixed(1), "%"))), /* @__PURE__ */ React.createElement("div", { className: "v2-sheet-actions" }, /* @__PURE__ */ React.createElement("button", { className: "v2-btn-ghost", onClick: onClose }, "Close")))),
    document.body
  );
}
...
function PicksTab({ pitchersOverride }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "v2-header" }, /* @__PURE__ */ React.createElement("div", { className: "v2-header-row" }, /* @__PURE__ */ React.createElement("div", { className: "v2-brand" }, /* @__PURE__ */ React.createElement("div", { className: "v2-kmark" }, "K"), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "v2-wordmark" }, "Betting Edge"), /* @__PURE__ */ React.createElement("div", { className: "v2-subtitle" }, (() => {
    ...
    Icon.refresh
  ), /* @__PURE__ */ React.createElement("button", { className: "v2-icon-btn", title: "Theme", onClick: () => window.__v2Theme?.toggleTheme() }, window.__v2Theme?.theme === "dark" ? Icon.sun : Icon.moon), /* @__PURE__ */ React.createElement("a", { href: "/legacy", className: "v2-classic-link", title: "Switch to classic dashboard" }, "classic"))), /* @__PURE__ */ React.createElement(DateBar, null)), past && /* @__PURE__ */ React.createElement(GradingSummary, { pitchers }), /* @__PURE__ */ React.createElement("div", { className: "v2-digest" }, /* @__PURE__ */ React.createElement("div", { className: "v2-digest-count" }, fires.length), /* @__PURE__ */ React.createElement("div", { className: "v2-digest-body" }, /* @__PURE__ */ React.createElement("div", { className: "v2-digest-title" }, "Fire picks today"), /* @__PURE__ */ React.createElement("div", { className: "v2-digest-sub" }, fires.length > 0 ? (() => {
    const avgEv = fires.reduce((s, p) => s + bestSide(p).adj_ev, 0) / fires.length * 100;
    const pre = fires.filter((p) => p.game_state === "pregame").length;
    return `${fires.length} actionable \xB7 avg EV ROI +${avgEv.toFixed(1)}% \xB7 ${pre} pregame`;
