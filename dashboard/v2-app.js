...
function PickCard({ p, onOpen }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    tracked.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "v2-tracked-row" }, tracked.map((pick, idx) => /* @__PURE__ */ React.createElement("span", { key: `${pick.direction}-${idx}`, className: `v2-tracked-pill ${pick.status === "locked" ? "locked" : ""}` }, pick.status === "locked" ? "Locked" : "Tracked", " ", pick.direction, " ", pick.k_line ?? p.k_line, " \xB7 ", pick.verdict))),
